...
Class Session extends Loader implements IteratorAggregate,ArrayAccess,Countable{
	...
	public function open()
	{
		...
		if(session_id()=='')
		{
			$this->message['session_error'] = 'Failed to start session.';
	...
	{
		isset($value)?session_name($value):session_name($this->value);
	}
	...
	public function setSavePath($value)
	{
		if(is_dir($value))
			...
			$this->message['session_error'][] = 'Path is not a valid directory.';
	}
	...
	public function setCookieMode($value)
	{
		...
		elseif($value==='only')
		{
			...
			$this->message['session_error'][] = 'cookieMode can only be "none", "allow" or "only".';
	}
	...
	public function setGCProbability($value)
	{
		if($value>=0 && $value<=100)
		{
			...
			$this->message['session_error'][] = 'CHttpSession.gcProbability "{value}" is invalid. It must be a float between 0 and 100.';
	}
